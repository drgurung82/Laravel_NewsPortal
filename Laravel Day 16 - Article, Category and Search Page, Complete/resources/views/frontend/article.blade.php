    ...
    <section class="py-6 md:py-8">
        <div class="container">
            ...
            <nav aria-label="Breadcrumb" class="text-sm text-gray-500 mb-4 flex flex-wrap items-center gap-1">
                ...
                @if ($primaryCategory)
                    <span>/</span>
                    <a class href="{{ route('category', $primaryCategory->slug) }}"
                ...
                <article class="md:col-span-2">
                    @if ($primaryCategory)
                        <a href="{{ route('category', $primaryCategory->slug) }}"
                            class="inline-block bg-(--primary) text-white text-xl font-semibold px-4 py-1 rounded-md mb-3">
                    ...
                    <div class="flex items-center gap-3 mt-8 pt-6 border-t border-gray-100">
                        ...
                        <a target="_blank" rel="noopener" aria-label="Facebook मा सेयर गर्नुहोस्"
                            ...
                            class="h-9 w-9 flex items-center justify-center rounded-full bg-purple-200 hover:bg-(--primary) hover:text-white transition">
