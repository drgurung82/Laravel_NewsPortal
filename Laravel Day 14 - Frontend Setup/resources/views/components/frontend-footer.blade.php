    ...
    <div class="container mx-auto px-6 py-10">
        ...
        <div class="container mx-auto flex justify-center py-1 pb-8">
            <div class="flex flex-wrap justify-center gap-2 sm:gap-3">
                <a href="/"
                    class="hover:text-white hover:bg-orange-500 text-[white] bg-[purple] px-2 py-1 border rounded-md">गृहपृष्ठ</a>
                <a href="/about"
        ...
        <div class="text-center text-[gray]">
            ...
            <a href="http://127.0.0.1:8000/" class="hover:text-orange-600 text-black">जवाफ डट कम</a>.
            सर्वाधिकार सुरक्षित
        </div>
    </div>
